...
public final class DefaultFlaskHud {
    ...
    /**
     * The liquid mask's opaque rows (the circle interior) and the clear rows under them, in
     * the icon's nine-point space: the interior spans rows 1 to 7 of the 9x9 icon.
     */
    private static final int LIQUID_ROWS = 7;
