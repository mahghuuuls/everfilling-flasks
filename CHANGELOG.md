...
- Hold-to-drink healing: drinking takes time, slows walking, and is cancelled by releasing the
  ...
  raised by ingredients and add-ons).
...
- Four flask ingredients found in dungeon, mineshaft, and village blacksmith chests: Sunpetal
...
- A public add-on API: register flasks and ingredients for your own items, contribute flask
